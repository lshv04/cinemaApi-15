...
function Nowplaying() {
  const { data, loading, error } = useFetch('https://api.themoviedb.org/3/movie/top_rated?language=pt-BR&page=1', options);
  ...
  return (
    <div className="container mt-4">
      <h1 className='text-center mb-4'>Mais bem avaliados</h1>
      <div className="row">
